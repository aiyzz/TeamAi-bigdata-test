...
| 源表 | 关联键 | 筛选条件 |
|------|--------|----------|
| nike.ods_jsc_t_market_direct_customer_dd | nike.kcode_crm_ks_dku.kcode = nike.ods_jsc_t_market_direct_customer_dd.k_code | settle_code LIKE 'ZK%' AND status = '1' AND up_time <= '20260614' AND expire_time >= '20260614' |
